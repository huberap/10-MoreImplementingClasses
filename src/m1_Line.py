...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.cloneNum = 0
        self.starti = self.start.clone()
        self.endi = self.end.clone()
    ...
    def line_plus(self, other_line):
        ...
        Type hints:
          ...
          :rtype: Line:
        """
        newx = self.start.x + other_line.start.x
        newy = self.start.y + other_line.start.y
        newx2 = self.end.x + other_line.end.x
        newy2 = self.end.y + other_line.end.y
        return Line(Point(newx,newy),Point(newx2,newy2))
    ...
    def midpoint(self):
        ...
        xmid = (self.end.x-self.start.x)/2
        ymid = (self.end.y-self.start.y)/2
        midpoint = Point(self.start.x+xmid,self.start.y+ymid)
        return midpoint
